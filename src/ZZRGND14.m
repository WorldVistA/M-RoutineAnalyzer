ZZRGND14 ;;CBR/AU - Used to extract and index data for the reports ;08/15/12
 ...
 Q ; Call tags
 ;
 ; Call main global update tags.  See CTBASE, NDXFI and READPKGS^ZZRGND19
MAIN(GLB,PKGSPATH) 
 S:$G(GLB)="" GLB="^ZZRG"
 D CRTBASE(GLB)
...
NDXTAG(GL,PKG,RTN,TAG,FLAG)
 ...
 D:'$D(@GL@(20,KEY,"RESULT")) BUILDRES(GL,PKG,RTN,ACTTAG,+$G(FLAG))
 M RESULT=@GL@(20,KEY,"RESULT")
 D MERGADDL(GL,KEY,.RESULT)
 ;
