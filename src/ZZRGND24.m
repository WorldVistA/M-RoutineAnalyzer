...
COMRTNS(GLB,PKG,NODE,FILEPATH,FILENAME) ;
 ...
 . Q:PKG'=@GLB@(10,PKG,"D")
 . S PKGNDX=PKGNDX+1
 . D COMRTSP(GLB,NODE,FILEPATH,FILENAME,PKG,PKGNDX)
 E  D COMRTSP(GLB,NODE,FILEPATH,FILENAME,PKG)
 D TEXTCLS^ZZRGND23("OUTFILE",FILENAME)
 Q
 ;
 ; Common tag from OPTRTNS and RPCRTNS
COMRTSP(GLB,NODE,FILEPATH,FILENAME,PKG,PKGNDX) ;
 N RTN,TAG,NAME,HAS
 S PKGNDX=$G(PKGNDX)
