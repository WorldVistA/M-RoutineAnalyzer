ZZRGND7 ;ISC/RWF - SETUP ENVITOMENT ;04/22/08  15:12
...
CMD ;;CMD;;B,BREAK,B:C,CLOSE,C:D,DO,D:E,ELSE,:F,FOR,F:G,GOTO,G:H,HALT,H:H,HANG,H:I,IF,:J,JOB,J:K,KILL,K:L,LOCK,L
