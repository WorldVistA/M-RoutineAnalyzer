...
FINDLOC(LOCAL) ;
 ...
 . S ISTART=+$P(ALL,"^",3)
 . K RESULT
 . M RESULT=^ZZRGT20(IRTN,ITAG,ISTART,"RESULT")
 . F T="I","O" D
 . . Q:'$D(RESULT(T,LOCAL))
 . . W T," >> ",ITAG_"^"_IRTN
 . . W:ISTART>0 " ("_ISTART_")"
 ...
 Q
 ;
FINDEN(TAG,RTN,START,TTAG,TRTN,PATH) ;
 N ITAG,IRTN,ISTART
 Q:$D(PATH("KEY",TAG_"^"_RTN))
 S PATH=$G(PATH)+1
 S PATH(PATH)=TAG_"^"_RTN
 S PATH("KEY",TAG_"^"_RTN)=""
 I TRTN=RTN,TTAG=TAG Q
 S IRTN=""
 F  S IRTN=$O(^ZZRGT20(RTN,TAG,START,"FI",IRTN))  Q:IRTN=""  D
 . S ITAG=""
 . F  S ITAG=$O(^ZZRGT20(RTN,TAG,START,"FI",IRTN,ITAG))  Q:ITAG=""  D
 . . S ISTART=""
 . . F  S ISTART=$O(^ZZRGT20(RTN,TAG,START,"FI",IRTN,ITAG,ISTART))  Q:ISTART=""  D
 . . . N THISPATH
 . . . M THISPATH=PATH
 . . . D FINDEN(ITAG,IRTN,ISTART,TTAG,TRTN,.THISPATH)
 Q 
 ;
