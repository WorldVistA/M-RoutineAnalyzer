...
ASK ;Ask for Build file, Package file.
 ...
 . S INP(11)="I $P(LIN,"";"",3)'["""_V_""" D E^ZZRGND1(44)",INP(11.1)=V
 . I $L($P(X,"*",3)) S INP(12)="I $P(LIN,"";"",5)'?.E1P1"""_$P(X,"*",3)_"""1P.E S ERR=56,ERR(1)=INP(12.1) D E^ZZRGND1(.ERR)",INP(12.1)=$P(X,"*",3)
 . Q
...
NEXT D ^ZZRGND11,REMCOMP:'INP(9) K A,B,C,C9,G,H,INDD,INDEL,INDF,INDFN,INDID,INDL,INDN,INDRN,INDSB,INDX,INDXN,INDXRF,DA,DIC,J,INDLC,INDC
 Q
