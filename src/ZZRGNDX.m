...
PRCSSCMS(RTN,LAB,LABO,LIN,LEVEL,V) ;GRB
 ...
 . I $L(CX) D HANDLCMD(RTN,LAB,LABO,CX,ARG,.V,POST,INIFELSE,LEVEL) I 1
 . E  D:ARG]"" HANDLARG(RTN,LAB,LABO,ARG,.V,LEVEL)
 . I CM="I"!(CM="E")!(CM="F") S INIFELSE=1
 . I CM="Q",'INIFELSE,'LEVEL,POST="" D ENDTRN(RTN,LAB,LABO)
 Q
 ;
...
UPDATGLB(RTN,LAB,LABO,VADDL,LEVEL) ;
 ...
 . I $D(VADDL(I,"VAL"))=1 S ^UTILITY($J,2,RTN,LAB,LABO,CNT,"VAL")=VADDL(I,"VAL") 
